...
(function () {
  ...
  function renderResults(saved) {
    ...
    app.innerHTML = '<section class="fade-in" style="padding-top:22px;">' +
      ...
      '<div class="cta-stack" style="margin-top:18px;"><a class="btn btn-primary" id="cta-book" href="' + esc(book) + '" target="_blank" rel="noopener">Book my AI strategy session</a></div>' +
      '</section>' +
      ...
      '<a class="btn btn-primary" id="cta-book-2" href="' + esc(book) + '" target="_blank" rel="noopener">Book my AI strategy session</a>' +
